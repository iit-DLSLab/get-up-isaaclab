...
.. code-block:: bash
    ...
    (TERMINAL 2)
    python3 ../get_up_isaaclab/exts/get_up_isaaclab/get_up_isaaclab/hyperparameter_tuning/tuner.py \
        --run_mode local --cfg_file ../get_up_isaaclab/exts/get_up_isaaclab/get_up_isaaclab/hyperparameter_tuning/locomotion_tuning_cfg.py \
        --cfg_class LocomotionAliengoFlatTuner \
        --workflow ../get_up_isaaclab/scripts/rsl_rl/train.py \
